...
<div class="row">
	<div class="col-md-9 form-group">
		<h2><spring:message code="administration.addTable"/></h2>
	</div>
</div>
...
<div class="row">
	<div class="col-md-9 form-group">
		...
		<input type="text" class="form-control" id="tableNumberInput" name="tableNumberInput">
	</div>
...
<div class="row">
	<div class="col-md-2 col-md-offset-8">
		<button onclick="location.href='tableAdministration'" class="btn btn-danger btn-block" id="abort"><span class="glyphicon glyphicon-remove"></span> <spring:message code="common.abort"/></button>
	</div>
	<div class="col-md-2">
