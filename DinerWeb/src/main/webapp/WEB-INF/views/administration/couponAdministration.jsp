...
<script type="text/javascript" src="js/form/administration/couponAdministration.js"></script>

<script type="text/javascript">
	$(document).ready(function() {
		new CouponAdministration();
	});
</script>
...
<div class="row">
	<div class="col-md-9 form-group">
		<h2><spring:message code="administration.coupons.menu"/></h2>
	</div>
...
<div class="bs-example bs-example-tabs">
	<div class="row">
		<div class="col-md-4 form-group">
			<button class="btn btn-primary btn-block" id="addCoupon"><span class="glyphicon glyphicon-plus"></span> <spring:message code="administration.addCoupon"/></button>
		</div>
	</div>
</div>
		...
		<thead>
	        <tr>
	            ...
	            <th><spring:message code="common.description"/></th>
	           	<th><spring:message code="administration.coupons.percentage"/></th>
	           	<th><spring:message code="administration.coupons.startingDate"/></th>
	           	<th><spring:message code="administration.coupons.expirationDate"/></th>
