...
CREATE TABLE `diner_test`.`category` (
	`id` int(8) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `diner_test`.`subcategory` (
	`id` int(8) NOT NULL AUTO_INCREMENT,
	`description` varchar(100) NOT NULL,
	`active` bit(1) NOT NULL,
...
CREATE TABLE `diner_test`.`product` (
	`id` int(8) NOT NULL AUTO_INCREMENT,
	`description` varchar(100) NOT NULL,
...
CREATE TABLE `diner_test`.`payment_media` (
	`id` int(8) NOT NULL AUTO_INCREMENT,
	`description` varchar(30) NOT NULL,
	PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `diner_test`.`order_detail` (
	`id` int(8) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `diner_test`.`order_table` (
	`id` int(8) NOT NULL AUTO_INCREMENT,
	`order_id` int(8) NOT NULL,
...
CREATE TABLE `diner_test`.`parameter` (
...
CREATE TABLE `diner_test`.`user_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
